...
// file: src/TreeBundle/Listener/DoctrineExtensionListener.php

namespace TreeBundle\Listener;
...
// Deb hack pour remplir createdby, updatedby... GillesBizarroïd
        $blameable = $this->container->get('gedmo.listener.blameable');
        $blameable->setUserValue('GL');
// Deb hack pour remplir createdby, updatedby... GillesBizarroïd
    }
